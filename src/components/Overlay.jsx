...
export const Gallery = () => {
  ...
  return (
<div style={{ width: isMobile ? '100vw' : '105vw', height: isMobile ? '100vh' : '110vh', transform: isMobile ? 'translate(0%, 0%)' : 'translate(-33.5%, 20%)', background: "radial-gradient(at -25% 35%, #2b2b42 0%, #14141d 40%, #06080c 80%, #06193d 100%)" }}>
